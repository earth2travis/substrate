...
The shared nervous system. Current inventory: 325 findings, 83 concepts, 2 entities, 355 raw sources.

## Core Directories
- [[research/]] — Incoming work. Raw sources in `raw/`; synthesized findings in `findings/`.
- [[insights/]] — Durable knowledge. Concepts in `concepts/`; entities in `entities/`.
- [[decisions/]] — Architecture Decision Records (ADRs).
- [[guides/]] — How-to procedures and workflows.

## Key Concepts
Agent operating model and design:
...
## Key Decisions
- [[kanban-metadata-rules]] — Structured metadata schemas for squad handoffs.

## Getting Started
Read [[CONTRIBUTING.md]] and [[SCHEMA.md]] before your first commit. Then read [[log.md]] for recent activity.
